...
import BlogImage from "../images/post_images/efb81bd1rxcsbtg449u2.webp";
import ProfileImage from "../images/profile/blank-profile-picture-973460_640.png";

function FeedCard() {
  return (
    <div>
      <div className="card border border-gray-300 bg-white rounded-lg my-3">
        <a href="/react">
          ...
          <div className="card-body p-4">
            ...
            <div className="card-content md:pl-11">
              <div className="heading">
                <h3 className=" text-xl md:text-3xl font-bold my-2 hover:text-blue-800">
              ...
              <div className="footer flex">
                ...
                <div className="bookmark-section ml-auto flex">
                  ...
                  <a
                    href=""
                    className="p-2 bg-gray-300 rounded text-gray-700 text-sm ml-2 hover:bg-gray-400"
                  >
                    Save
                  </a>
                </div>
